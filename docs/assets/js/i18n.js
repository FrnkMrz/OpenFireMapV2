 ...
 * ZWECK: Enthält alle Texte für die Webseite in verschiedenen Sprachen.
 * LERN-ZIEL: Wie man Texte dynamisch austauscht (Translation Dictionary).
 * ==========================================================================================
 */

// DAS WÖRTERBUCH (Dictionary)
// Hier stehen alle Texte. Links ist der "Schlüssel" (den wir im HTML nutzen),
// rechts steht der echte Text.
const dictionary = {
    // -------------------------------------------------------------------------
    // DEUTSCH (DE)
    // -------------------------------------------------------------------------
    de: {
        ...
        layers_title: "Hintergrundkarte wählen",
        export_title: "Export & Drucken",
        legal_btn: "Info & Recht",
        
        // Status unten rechts (Die fehlenden Werte!)
        zoom_info: "ZOOM",
        data_info: "DATEN",
        ...
        layer_topo: "Topographisch",
        layer_osm: "OSM (Standard)",
        layer_osmde: "OSM (Deutsch)",

        // Export Menü
        export_header: "Export-Einstellungen",
        format_label: "Format",
        fmt_free: "FREI",
        fmt_a4l: "DIN A4 QUER",
        fmt_a4p: "DIN A4 HOCH",
        zoom_label: "Zoom-Detail",
        select_area_btn: "Ausschnitt wählen",
        area_fixed: "Ausschnitt fixiert ✓",
        png_btn: "Als Bild speichern (PNG)",
        gpx_btn: "Als Daten speichern (GPX)",
        exporting_title: "Export läuft...",
        cancel_btn: "Abbrechen",
        
        // Status-Meldungen (unten rechts & Popups)
        status_loading: "LÄDT...",
        ...
        err_ratelimit: "Zu viele Anfragen! Warte kurz...",
        err_timeout: "Server überlastet. Bitte näher ranzoomen.",
        err_offline: "Keine Internetverbindung.",
        
        // JavaScript Nachrichten (Alerts/Toasts)
        no_results: "Ort nicht gefunden",
        geo_error: "GPS Fehler",
        geo_found: "Standort gefunden",
        geo_fail: "Standort nicht ermittelbar",
        drag_area: "Ziehe jetzt einen Rahmen auf der Karte!",
        no_objects: "Keine Objekte im Ausschnitt",
        gpx_success: "GPX erfolgreich exportiert",
        too_large: "Bereich ist zu groß für diesen Zoom!",
        
        // Export Fortschritt
        locating: "Bestimme Ort...",
        loading_tiles: "Lade Kartenteile...",
        render_bounds: "Zeichne Grenzen...",
        render_infra: "Zeichne Hydranten...",
        layout_final: "Erstelle Layout...",
    ...
    en: {
        ...
        layers_title: "Switch Background",
        export_title: "Export & Print",
        ...
        fmt_a4p: "A4 PORTRAIT",
        zoom_label: "Detail Level",
        select_area_btn: "Select Area",
        area_fixed: "Area fixed ✓",
        png_btn: "Save Image (PNG)",
        gpx_btn: "Save Data (GPX)",
        ...
        err_ratelimit: "Too many requests! Please wait.",
        err_timeout: "Server overload. Please zoom in.",
        ...
        drag_area: "Draw a box on the map now!",
        no_objects: "No objects in area",
        gpx_success: "GPX exported successfully",
        too_large: "Area too large for this zoom level!",
    ...
    // TIPP: Hier kannst du deine anderen Sprachen (FR, ES, PL etc.) 
    // aus der alten Datei einfügen! Einfach den Block kopieren.
};
