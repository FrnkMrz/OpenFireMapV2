...
export const strings = {
    ...
    csv_btn: "Hydranten exportéieren (CSV)",
    ...
    csv_success: "Objeten als CSV exportéiert!",
    ...
    "export_confirm_header": "Passt w.e.g. den Titel fir d'Kaart un",
    "export_confirm_text": "",
    "cached_objects": "Objeten aus dem Cache",
    "data_complete": "Daten komplett gelueden",
    "server_overloaded_wait": "All Servere besat, waarden",
    "trying_server": "Probéieren",
    "server_ratelimit_retry": "Server besat (429), probéieren nächste Server...",
    "all_servers_busy": "All Servere besat, probéiert et w.e.g. méi spéit nach eng Kéier",
    "server_error_retry": "Serverfeeler",
    "showing_cached": "weisen tëschegespäichert Daten",
    "server_error_type_overload": "Iwwerlaascht",
    "server_error_type_server": "Serverfeeler",
    "server_error_type_connection": "Verbindungsproblem",
    "alt_server": "alternative Server",
    "next_server": "nächste Server",
    "seconds_short": "s",
    "objects": "Objeten"
,
