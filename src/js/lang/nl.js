...
export const strings = {
    ...
    csv_btn: "Exporteer naar CSV",
        ...
        from_cache: "Uit cache",
        data_updated: "Bijgewerkt",
        refreshing: "controleren op updates",
        no_objects: "Geen objecten in gebied!",
        gpx_success: "Geëxporteerd als GPX!",
    csv_success: "Geëxporteerd als CSV!",
    ...
    "export_confirm_header": "Pas de titel voor de kaart aan",
    "export_confirm_text": "",
    "cached_objects": "Objecten uit cache",
    "data_complete": "Data volledig geladen",
    "server_overloaded_wait": "Alle servers bezet, even wachten",
    "trying_server": "Proberen",
    "server_ratelimit_retry": "Server bezet (429), volgende server proberen...",
    "all_servers_busy": "Alle servers bezet, probeer het later opnieuw",
    "server_error_retry": "Serverfout",
    "showing_cached": "gecachete data tonen",
    "server_error_type_overload": "Overbelasting",
    "server_error_type_server": "Serverfout",
    "server_error_type_connection": "Verbindingsprobleem",
    "alt_server": "alternatieve server",
    "next_server": "volgende server",
    "seconds_short": "s",
    "objects": "objecten"
,
    cluster_info: "Objecten binnen 5m",
