...
export const strings = {
    ...
    "export_confirm_header": "지도의 제목을 조정해 주세요",
    "export_confirm_text": "",
    "cached_objects": "캐시의 객체",
    "data_complete": "데이터 완전히 로드됨",
    "server_overloaded_wait": "모든 서버가 사용 중입니다. 대기 중",
    "trying_server": "시도 중",
    "server_ratelimit_retry": "서버가 사용 중(429), 다음 서버 시도 중...",
    "all_servers_busy": "모든 서버가 사용 중입니다. 나중에 다시 시도해 주세요",
    "server_error_retry": "서버 오류",
    "showing_cached": "캐시된 데이터 표시 중",
    "server_error_type_overload": "과부하",
    "server_error_type_server": "서버 오류",
    "server_error_type_connection": "연결 문제",
    "alt_server": "대체 서버",
    "next_server": "다음 서버",
    "seconds_short": "초",
    "objects": "객체"
