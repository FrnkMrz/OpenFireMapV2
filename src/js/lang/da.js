...
export const strings = {
    ...
    csv_btn: "Eksporter hydranter (CSV)",
        ...
        data_updated: "Opdateret",
        refreshing: "tjekker opdateringer",
        no_objects: "Ingen objekter i det valgte område!",
        gpx_success: "Objekter eksporteret som GPX!",
    csv_success: "Objekter eksporteret som CSV!",
    ...
    "export_confirm_header": "Juster venligst titlen på kortet",
    "export_confirm_text": "",
    "cached_objects": "Objekter fra cache",
    "data_complete": "Data fuldt indlæst",
    "server_overloaded_wait": "Alle servere er optaget, venter",
    "trying_server": "Prøver",
    "server_ratelimit_retry": "Server optaget (429), prøver næste server...",
    "all_servers_busy": "Alle servere er optaget, prøv igen senere",
    "server_error_retry": "Serverfejl",
    "showing_cached": "viser cachelagrede data",
    "server_error_type_overload": "Overbelastning",
    "server_error_type_server": "Serverfejl",
    "server_error_type_connection": "Forbindelsesproblem",
    "alt_server": "alternativ server",
    "next_server": "næste server",
    "seconds_short": "s",
    "objects": "objekter"
,
