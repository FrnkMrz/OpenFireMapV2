...
export const strings = {
    ...
    csv_success: "对象已导出为 CSV！",
        ...
        defib: "除颤器 (AED)",
        legal_btn: "信息与法律",
        menu_layers_open: "打开图层",
        menu_layers_close: "关闭图层",
        menu_layers_label: "图层",
    ...
    no_results: "找不到结果",
    loading_data: "正在加载数据...",
    "export_confirm_header": "请调整地图的标题",
    "export_confirm_text": "",
    "cached_objects": "来自缓存的对象",
    "data_complete": "数据已完全加载",
    "server_overloaded_wait": "所有服务器忙碌，请稍候",
    "trying_server": "尝试中",
    "server_ratelimit_retry": "服务器忙碌 (429)，正在尝试下一个服务器...",
    "all_servers_busy": "所有服务器忙碌，请稍后再试",
    "server_error_retry": "服务器错误",
    "showing_cached": "显示缓存数据",
    "server_error_type_overload": "超载",
    "server_error_type_server": "服务器错误",
    "server_error_type_connection": "连接问题",
    "alt_server": "备用服务器",
    "next_server": "下一个服务器",
    "seconds_short": "秒",
    "objects": "对象"
