...
export const strings = {
    ...
    csv_btn: "Exportar Hidrantes (CSV)",
    ...
    csv_success: "Objetos exportados como CSV!",
    ...
    "export_confirm_header": "Por favor, ajuste o título do mapa",
    "export_confirm_text": "",
    "cached_objects": "Objetos do cache",
    "data_complete": "Dados totalmente carregados",
    "server_overloaded_wait": "Todos os servidores ocupados, aguardando",
    "trying_server": "A tentar",
    "server_ratelimit_retry": "Servidor ocupado (429), a tentar o próximo...",
    "all_servers_busy": "Todos os servidores ocupados, tente novamente",
    "server_error_retry": "Erro no servidor",
    "showing_cached": "a mostrar dados em cache",
    "server_error_type_overload": "Sobrecarga",
    "server_error_type_server": "Erro no servidor",
    "server_error_type_connection": "Problema de ligação",
    "alt_server": "servidor alternativo",
    "next_server": "próximo servidor",
    "seconds_short": "s",
    "objects": "objetos"
,
    cluster_info: "Objetos num raio de 5m",
    details_hydrant: "Detalhes do hidrante",
