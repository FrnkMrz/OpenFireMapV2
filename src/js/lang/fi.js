...
export const strings = {
    ...
    csv_btn: "Vie palopostit (CSV)",
        ...
        drag_area: "Vedä alue",
        from_cache: "Välimuistista",
        data_updated: "Päivitetty",
        refreshing: "tarkistetaan päivityksiä",
        no_objects: "Ei kohteita valitulla alueella!",
        gpx_success: "Kohteet viety GPX-muodossa!",
    csv_success: "Kohteet viety CSV-muodossa!",
    ...
    "export_confirm_header": "Säädä kartan otsikkoa",
    "export_confirm_text": "",
    "cached_objects": "Objektit välimuistista",
    "data_complete": "Tiedot ladattu kokonaan",
    "server_overloaded_wait": "Kaikki palvelimet varattu, odotetaan",
    "trying_server": "Yritetään",
    "server_ratelimit_retry": "Palvelin varattu (429), yritetään seuraavaa palvelinta...",
    "all_servers_busy": "Kaikki palvelimet varattu, yritä myöhemmin uudelleen",
    "server_error_retry": "Palvelinvirhe",
    "showing_cached": "näytetään välimuistissa olevat tiedot",
    "server_error_type_overload": "Ylikuormitus",
    "server_error_type_server": "Palvelinvirhe",
    "server_error_type_connection": "Yhteysongelma",
    "alt_server": "vaihtoehtoinen palvelin",
    "next_server": "seuraava palvelin",
    "seconds_short": "s",
    "objects": "objektit"
,
