...
export const strings = {
    ...
    csv_btn: "ส่งออกหัวดับเพลิง (CSV)",
        ...
        from_cache: "จากแคช",
        data_updated: "อัปเดตแล้ว",
        refreshing: "กำลังตรวจสอบการอัปเดต",
        no_objects: "ไม่มีวัตถุในพื้นที่ที่เลือก!",
        gpx_success: "ส่งออกวัตถุเป็น GPX แล้ว!",
    csv_success: "ส่งออกวัตถุเป็น CSV แล้ว!",
    ...
    "export_confirm_header": "โปรดปรับชื่อสำหรับแผนที่",
    "export_confirm_text": "",
    "cached_objects": "วัตถุจากแคช",
    "data_complete": "โหลดข้อมูลครบแล้ว",
    "server_overloaded_wait": "เซิร์ฟเวอร์ทั้งหมดไม่ว่าง กำลังรอ",
    "trying_server": "กำลังลอง",
    "server_ratelimit_retry": "เซิร์ฟเวอร์ไม่ว่าง (429) กำลังลองเซิร์ฟเวอร์ถัดไป...",
    "all_servers_busy": "เซิร์ฟเวอร์ทั้งหมดไม่ว่าง โปรดลองอีกครั้งในภายหลัง",
    "server_error_retry": "ข้อผิดพลาดของเซิร์ฟเวอร์",
    "showing_cached": "กำลังแสดงข้อมูลที่แคช",
    "server_error_type_overload": "โอเวอร์โหลด",
    "server_error_type_server": "ข้อผิดพลาดของเซิร์ฟเวอร์",
    "server_error_type_connection": "ปัญหาการเชื่อมต่อ",
    "alt_server": "เซิร์ฟเวอร์ทางเลือก",
    "next_server": "เซิร์ฟเวอร์ถัดไป",
