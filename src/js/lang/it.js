...
export const strings = {
    ...
    "export_confirm_header": "Per favore modifica il titolo della mappa",
    "export_confirm_text": "",
    "cached_objects": "Oggetti dalla cache",
    "data_complete": "Dati caricati completamente",
    "server_overloaded_wait": "Tutti i server occupati, in attesa",
    "trying_server": "Tentativo",
    "server_ratelimit_retry": "Server occupato (429), tento il server successivo...",
    "all_servers_busy": "Tutti i server occupati, riprova più tardi",
    "server_error_retry": "Errore del server",
    "showing_cached": "mostrando i dati in cache",
    "server_error_type_overload": "Sovraccarico",
    "server_error_type_server": "Errore del server",
    "server_error_type_connection": "Problema di connessione",
    "alt_server": "server alternativo",
