...
export const strings = {
    ...
    csv_success: "¡Objetos exportados a CSV!",
    ...
    "export_confirm_header": "Por favor, ajuste el título para el mapa",
    "export_confirm_text": "",
    "cached_objects": "Objetos de la caché",
    "data_complete": "Datos completamente cargados",
    "server_overloaded_wait": "Todos los servidores ocupados, esperando",
    "trying_server": "Intentando",
    "server_ratelimit_retry": "Servidor ocupado (429), intentando el siguiente...",
    "all_servers_busy": "Todos los servidores ocupados, inténtelo más tarde",
    "server_error_retry": "Error de servidor",
    "showing_cached": "mostrando datos en caché",
    "server_error_type_overload": "Sobrecarga",
    "server_error_type_server": "Error de servidor",
    "server_error_type_connection": "Problema de conexión",
    "alt_server": "servidor alternativo",
    "next_server": "siguiente servidor",
    "seconds_short": "s",
    "objects": "objetos"
,
    cluster_info: "Objetos a menos de 5m",
    details_hydrant: "Detalles del hidrante",
