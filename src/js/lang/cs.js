...
export const strings = {
    ...
    csv_btn: "Exportovat do CSV",
        ...
        data_updated: "Aktualizováno",
        refreshing: "kontroluji aktualizace",
        no_objects: "Žádné objekty v oblasti!",
        gpx_success: "Exportováno do GPX!",
    csv_success: "Exportováno do CSV!",
    ...
    "export_confirm_header": "Upravte prosím název mapy",
    "export_confirm_text": "",
    "cached_objects": "Objekty z mezipaměti",
    "data_complete": "Data jsou plně načtena",
    "server_overloaded_wait": "Všechny servery jsou zaneprázdněny, čekejte",
    "trying_server": "Zkouším",
    "server_ratelimit_retry": "Server je zaneprázdněn (429), zkouším další server...",
    "all_servers_busy": "Všechny servery jsou zaneprázdněny, zkuste to prosím později",
    "server_error_retry": "Chyba serveru",
    "showing_cached": "zobrazují se data z mezipaměti",
    "server_error_type_overload": "Přetížení",
    "server_error_type_server": "Chyba serveru",
    "server_error_type_connection": "Problém s připojením",
    "alt_server": "alternativní server",
    "next_server": "další server",
    "seconds_short": "s",
    "objects": "objekty"
,
    cluster_info: "Objekty v okruhu 5m",
    details_hydrant: "Detaily hydrantu",
