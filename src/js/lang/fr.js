...
export const strings = {
    ...
    csv_btn: "Exporter en CSV",
        ...
        refreshing: "vérification des mises à jour",
        no_objects: "Aucun objet dans la zone !",
        gpx_success: "Objets exportés en GPX !",
    csv_success: "Objets exportés en CSV !",
    ...
    "export_confirm_header": "Veuillez ajuster le titre de la carte",
    "export_confirm_text": "",
    "cached_objects": "Objets du cache",
    "data_complete": "Données entièrement chargées",
    "server_overloaded_wait": "Tous les serveurs sont occupés, attendez",
    "trying_server": "Essai",
    "server_ratelimit_retry": "Serveur occupé (429), essai du serveur suivant...",
    "all_servers_busy": "Tous les serveurs occupés, réessayez plus tard",
    "server_error_retry": "Erreur serveur",
    "showing_cached": "affichage des données en cache",
    "server_error_type_overload": "Surcharge",
    "server_error_type_server": "Erreur serveur",
    "server_error_type_connection": "Problème de connexion",
    "alt_server": "serveur alternatif",
    "next_server": "serveur suivant",
    "seconds_short": "s",
    "objects": "objets"
,
    cluster_info: "Objets dans un rayon de 5m",
    details_hydrant: "Détails de l'hydrante",
