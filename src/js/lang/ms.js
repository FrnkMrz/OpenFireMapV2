...
export const strings = {
    ...
    csv_btn: "Eksport Pili Bomba (CSV)",
        ...
        data_updated: "Dikemas kini",
        refreshing: "menyemak kemas kini",
        no_objects: "Tiada objek di kawasan yang dipilih!",
        gpx_success: "Objek dieksport sebagai GPX!",
    csv_success: "Objek dieksport sebagai CSV!",
    ...
    "export_confirm_header": "Sila laraskan tajuk untuk peta",
    "export_confirm_text": "",
    "cached_objects": "Objek dari cache",
    "data_complete": "Data dimuat sepenuhnya",
    "server_overloaded_wait": "Semua pelayan sibuk, menunggu",
    "trying_server": "Mencuba",
    "server_ratelimit_retry": "Pelayan sibuk (429), mencuba pelayan seterusnya...",
    "all_servers_busy": "Semua pelayan sibuk, sila cuba lagi nanti",
    "server_error_retry": "Ralat pelayan",
    "showing_cached": "menunjukkan data cache",
    "server_error_type_overload": "Beban lampau",
    "server_error_type_server": "Ralat pelayan",
    "server_error_type_connection": "Masalah sambungan",
    "alt_server": "pelayan alternatif",
    "next_server": "pelayan seterusnya",
    "seconds_short": "s",
    "objects": "objek"
,
